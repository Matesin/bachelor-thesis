...
\abstractEN {
   ...
   The result of this thesis is a functional implementation of NFC communication for the LionKey security key using the STEVAL-D25R16B platform. The resulting implementation is publicly available on GitHub. It extends the device's capabilities by allowing its use with services supporting WebAuthn.
}
\abstractCZ {
...
\keywordsEN {%
   NFC, WebAuthn, CTAP2, hardware~security~key, ISO/IEC-14443, LionKey
}
\keywordsCZ {%
   NFC, WebAuthn, CTAP2, hardwarový~bezpečnostní~klíč, ISO/IEC-14443, LionKey
}

\thanks {           % Use main language here
   I would like to thank my supervisor, Ing.~Jan~Sobotka,~Ph.D. for his guidance and assistance, doc.~Ing.~Jiří~Novák,~Ph.D. for introducing me to the topic of this thesis and to Ing.~Martin~Endler for his patience, enthusiasm and for the trust he put in me in continuing his LionKey project. Also, I would like to thank my father for always supporting me throughout my studies and to Mgr.~Zdeněk~Vítek for being the Czech Biathlon GOAT.
}
