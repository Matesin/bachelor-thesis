...
As quantum computing technology advances, it poses a significant {\sbf long-term threat} to the currently used public-key cryptographic schemes~\cite[enwiki:1349019275]. Although no quantum computer is currently capable of breaking them, the issue is important to acknowledge. Therefore, we provide a brief examination of the {\sbf post-quantum (PQ) security} of the CTAP protocol.
